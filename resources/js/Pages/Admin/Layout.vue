    ...
    <aside class="w-60 bg-[#0F172A] text-white flex-shrink-0 flex flex-col sticky top-0 h-screen overflow-y-auto">
      ...
      <div class="px-5 py-4 border-b border-white/[0.06]">
        <a href="/admin/dashboard" class="flex items-center gap-2.5">
          <img :src="'/images/logo.png?v=2'" alt="PeptideMaps" class="h-8 brightness-0 invert" />
      ...
      <nav class="flex-1 px-3 py-4 space-y-6">
        ...
        <div>
          ...
          <NavItem v-if="$page.props.is_ceo" href="/admin/ceo" icon="crown" label="CEO" />
        </div>
...
const NavItem = defineComponent({
  ...
  setup(props) {
    const icons = {
      ...
      crown: 'M2 20h20l-2-11-5 4-5-8-5 8-5-4z',
