    ...
    <div v-if="showNotice" class="fixed top-0 left-0 right-0 z-[60] bg-[#0A0B0E] text-white">
      <div class="max-w-[1280px] mx-auto px-4 lg:px-10 h-9 flex items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-[13px] relative">
        ...
        <template v-else>
          ...
          <span class="text-white/70 truncate min-w-0"><span class="hidden sm:inline">Deals, price drops, and vendor reviews — live in our </span><span class="sm:hidden">Join our </span><strong class="text-white font-semibold">Discord</strong></span>
