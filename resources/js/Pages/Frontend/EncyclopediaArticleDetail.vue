        ...
        <div class="max-w-[1280px] mx-auto px-6 lg:px-10 py-6 relative z-10">
          ...
          <div class="flex flex-col lg:flex-row gap-6 mb-0">
            <div class="flex-1 min-w-0">
              ...
              <p v-if="overview" class="text-[15px] text-[color:var(--color-ink-muted)] leading-relaxed mb-4" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: clip;">{{ overview }}</p>
