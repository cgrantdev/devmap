    ...
    <section v-if="heroSlides.length > 0" class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="rounded-xl overflow-hidden shadow-lg">
          <div
            class="relative h-96 bg-slate-800"
            ...
            >
              ...
              <div class="relative h-full flex items-center px-16">
                <div class="max-w-2xl text-white">
                  <div class="text-sm uppercase tracking-wide mb-2 text-slate-300">
                  ...
                  <div class="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/30 px-5 py-3 rounded-lg mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tag w-5 h-5 text-slate-300">
                      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"></path>
                      <circle cx="7.5" cy="7.5" r=".5" fill="currentColor"></circle>
                    </svg>
                    <span class="text-lg">Use code:</span>
                    <span class="text-xl text-slate-200">{{ slide.promoCode || 'PMAP' }}</span>
                  </div>
