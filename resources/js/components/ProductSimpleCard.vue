<template>
    <div
      class="bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all cursor-pointer overflow-hidden group flex flex-col"
      @click="handleClick"
    >
      ...
      <div class="p-4 flex flex-col h-full">  
        <!-- Product Title -->
        <h3 class="text-sm text-gray-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors min-h-[2.5rem]">
          {{ name }}
        </h3>  
  
        <!-- Rating -->
        <div class="flex items-center gap-1 mb-2 min-h-[1.5rem]">
        ...
        <!-- Price -->
        <div class="text-lg text-gray-900 min-h-[1.75rem]">
          ${{ displayPrice }}
        </div>       
      </div>
    </div>
