  ...
  >
    ...
    <div class="absolute top-3 right-3 z-10 bg-red-600 text-white px-3 py-1 rounded-full text-sm shadow-lg">
      <div class="flex items-center gap-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-down w-4 h-4" aria-hidden="true">
    ...
    <div class="aspect-square bg-gray-50 p-8 border-b border-gray-200 flex items-center justify-center">
      ...
      <template v-else>
        <div 
          class="w-20 h-20 text-xl bg-blue-500 rounded-lg flex items-center justify-center text-white select-none"
    ...
    <div class="p-4">
      <!-- Company Name -->
      <h3 class="text-lg text-gray-900 mb-3 text-center group-hover:text-slate-700 transition-colors">
        {{ name }}
      </h3>
      ...
      <div class="mt-3 pt-3 border-t border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-xs bg-slate-700 text-white px-2 py-1 rounded">
            {{ code }}
          </span>
        </div>
      </div>
