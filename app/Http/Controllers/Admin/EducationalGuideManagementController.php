...
class EducationalGuideManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'guide_type' => 'required|string|in:Beginner,Stacking,Dosage,Advanced',
            'tag' => 'nullable|string|max:255',
            'reading_time' => 'nullable|string|max:255',
            'description' => 'nullable|string',
            'outline' => 'nullable|string',
            'introduction' => 'nullable|string',
            'overview_benefits' => 'nullable|array',
            'overview_benefits.*.title' => 'nullable|string',
            'overview_benefits.*.description' => 'nullable|string',
            'usage_guidelines_important_note' => 'nullable|string',
            'dosage_recommendation' => 'nullable|array',
            'dosage_recommendation.*' => 'nullable|string',
            'administration_methods' => 'nullable|array',
            'administration_methods.*' => 'nullable|string',
            'timing_frequency' => 'nullable|string',
            'safety_first' => 'nullable|string',
            'common_side_effects' => 'nullable|array',
            'common_side_effects.*' => 'nullable|string',
            'contraindications' => 'nullable|array',
            'contraindications.*' => 'nullable|string',
            'storage_handling' => 'nullable|array',
            'storage_handling.*' => 'nullable|string',
            'dos' => 'nullable|array',
            'dos.*' => 'nullable|string',
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Admin/EducationalGuideEdit', [
            'guide' => [
                ...
                'overview_benefits' => $guide->overview_benefits ?? [],
                'usage_guidelines_important_note' => $guide->usage_guidelines_important_note,
                'dosage_recommendation' => $guide->dosage_recommendation ?? [],
                'administration_methods' => $guide->administration_methods ?? [],
                'timing_frequency' => $guide->timing_frequency,
                'safety_first' => $guide->safety_first,
                'common_side_effects' => $guide->common_side_effects ?? [],
                'contraindications' => $guide->contraindications ?? [],
                'storage_handling' => $guide->storage_handling ?? [],
                'dos' => $guide->dos ?? [],
                'donts' => $guide->donts ?? [],
