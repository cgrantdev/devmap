...
Route::middleware(['auth', 'role:admin,admin_viewer', 'email.verified', 'block.viewer.writes'])->prefix('admin')->group(function () {
    ...
    // GSC OAuth — kept OUTSIDE the /ceo prefix so the redirect URI
    // registered in Google Cloud (/admin/gsc/callback) matches what
    // Laravel actually routes. Same ceo.only gate applies.
